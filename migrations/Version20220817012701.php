 ...
 */
final class Version20220817012701 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, semester_id INT DEFAULT NULL, subject_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, info VARCHAR(255) NOT NULL, attendance VARCHAR(255) NOT NULL, grade DOUBLE PRECISION NOT NULL, INDEX IDX_169E6FB94A798B6F (semester_id), INDEX IDX_169E6FB923EDC87 (subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, major_id INT DEFAULT NULL, classes_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, INDEX IDX_B723AF33E93695C7 (major_id), INDEX IDX_B723AF339E225B24 (classes_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
